...
test('standalone Jalan Dao 8.1.4 hydrates without SiteGPT', async ({ page }) => {
  ...
  await expect(page).toHaveTitle(/Jalan Dao/i);
  await expect(page.getByText('Jalan Dao', { exact: true }).first()).toBeVisible();
